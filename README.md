...
[![PyPI](https://img.shields.io/pypi/v/cognis-otaverify.svg)](https://pypi.org/project/cognis-otaverify/)
[![CI](https://github.com/cognis-digital/otaverify/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/otaverify/actions)
...
OTAVERIFY exists for one job — validate ota update packages end-to-end: signature chains, rollback protection, anti-downgrade counters, and delta-patch integrity. — and does it without a SaaS bill or heavyweight setup.
...
```bash
otaverify --version
otaverify scan .                      # scan the current project
otaverify scan . --format json
otaverify scan . --fail-on high       # non-zero exit for CI gates
otaverify mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **TUF / Uptane + Mender**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`otaverify` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
