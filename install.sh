#!/usr/bin/env sh
# Universal installer for otaverify. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/otaverify.git"
echo "Installing otaverify ..."
